...
As a TL;DR, in total, over 3 projects there have been:
...
My top projects, as gleaned from `env GITHUB_TOKEN=.... bundle exec ruby github.rb 2017`, in the folder `_includes/src/2017-year-in-review`:

Project jamietanna/dotfiles-arch has had:
- 2 total issues
  - 2 issues open

Project HackSocNotts/wit-deprecated has had:
- 1 total Merge Request
  - 1 MRs open

Project HackSocNotts/HackSocNotts.github.io has had:
- 1 total issue
  - 1 issues open
