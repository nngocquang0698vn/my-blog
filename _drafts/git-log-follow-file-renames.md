...
tags: git cli shell blogumentation
no_toc: true
image: /assets/img/vendor/git.png
---
You'll often want to see the various changes that have been made to a file over time:

<asciinema-player src="/assets/casts/git-log-file-renames/no-follow.json"></asciinema-player>
...
<asciinema-player src="/assets/casts/git-log-file-renames/follow.json"></asciinema-player>
