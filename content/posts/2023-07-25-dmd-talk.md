...
slug: dmd-talk
---
This is a writeup of [my talk at DevOpsNotts July 2023](https://www.meetup.com/devops-notts/events/293929326/) about [the dependency-management-data project](https://dmd.tanna.dev). The talk abstract can be found [on my talks site](https://talks.jvt.me/dmd/).
...
An example of these reports can be found on the [example web app](https://dependency-management-data-example.fly.dev/report/advisories) (note that [not all of the reports are implemented](https://gitlab.com/tanna.dev/dependency-management-data/-/issues/133)).
