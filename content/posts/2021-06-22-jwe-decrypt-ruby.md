...
As mentioned in [_Why I Actively Discourage Online Tooling like `jwt.io` and Online JSON Validators_]({{< ref 2020-09-01-against-online-tooling >}}), I like having the option to use offline tools (which I can audit more easily) for common tasks.
