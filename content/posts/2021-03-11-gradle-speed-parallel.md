...
I've seen this more commonly when using [slf4j-test for testing your SLF4J logs](/posts/2019/09/22/testing-slf4j-logs/), where we need to make sure we use the right thread-safe option, so we don't clear / retrieve logs from different threads:
