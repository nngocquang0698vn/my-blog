...
description: "How to dip your toes into Vim to learn some of the basics."
tags:
- vim
- emacs
- getting-started
...
I was watching one of the [Destroy All Software screencasts](https://www.destroyallsoftware.com/screencasts), and found that <span class="h-card"><a class="u-url" href="https://www.destroyallsoftware.com">Gary Bernhardt</a></span> was moving so fluidly around the screen, and performing such keyboard magic I knew I wanted to be half that productive.
...
I, _of course_, decided that Emacs was an easier tool to work with. I don't know how I got to that decision, but it was a bit foolish, although it gave me some good experience with it, and to play around with Elisp.

After a while of fighting against needing to install ~180MB of packages every time I wanted to edit a file on a new machine, I decided that I'd look at Vim, because at least Vi is installed on [every POSIX-compliant machine](https://unix.stackexchange.com/a/194438), so it's a safe bet to learn it.
...
[Vim Adventures](https://vim-adventures.com/) is a web-based game that uses the Vim keybindings to navigate, and is a great way to gamify the learning process, where you progress by learning new commands that allow you to overcome new obstacles.
