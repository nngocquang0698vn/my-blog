...
Update 2019-12-04: I've written up how to get `SSL_CERT_DIR` working in my blog post [_Setting up a directory for OpenSSL's `SSL_CERT_DIR_](/posts/2019/12/04/openssl-certs-dir-setup/).
