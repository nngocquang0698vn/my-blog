---
title: "Introducing the `tidied` tool, to more easily check whether `go mod tidy` has been run"
description: "Why I've created a command-line application called `tidied` to check `go mod tidy` has been run."
