...
After the announcement, I was still thinking that I would continue to own the Indie event on my own site, under [/events/homebrew-website-club-nottingham/](/events/homebrew-website-club-nottingham/), and maybe syndicate out to the IndieWeb Events site, but after a conversation with Aaron on Wednesday I realised that this doesn't make much sense.

As Aaron says, [the Homebrew Website Club events belong to the community](https://chat.indieweb.org/meta/2020-01-08/1578509777209600), not me, which I wholeheartedly agree with. And as I may not be in Nottingham forever, it makes sense for it not to be synonymous with my own website and identity. Although I had used my own site in the past, so I didn't need to buy a new domain to host it, that was more for convenience, and I didn't expect it to be the long-term home for the event.

The IndieWeb Events site is really awesome, and will do things like pick up any mentions on your own website (via a Webmention) or on social media such as Twitter, so conversations can be included back in one place, similar to my own setup. However, Aaron's added a killer feature which is collating any photos that are mentioned, as per [Homebrew Website Club: Nottingham on January 8th](https://events.indieweb.org/2020/01/homebrew-website-club-nottingham-7af4r0X4AeA0), which means you'll appear on [This Week in the IndieWeb](https://indieweb.org/this-week/2020-01-10.html) more easily!

Because I still want the ability to have the events discoverable by the great site [Nottingham.Digital](https://nottingham.digital), I will tag events as `hwc-nottingham`, so folks can still find out what's coming up by going to [https://events.indieweb.org/tag/hwc-nottingham](https://events.indieweb.org/tag/hwc-nottingham).
...
You can subscribe to the iCalendar feed by adding `https://events.indieweb.org/ics/tag/hwc-nottingham.ics` to you calendar app of choice, and remove the existing one from this site, as it'll no longer be updated.
