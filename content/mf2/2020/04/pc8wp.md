{
  ...
  "properties" : {
    ...
    "content" : [ {
      "html" : "",
      "value" : "Sorry, the Alpine one wouldn't be helpful anyway. The Arch package (https://www.archlinux.org/packages/community/x86_64/nextcloud-client/) has the `nextcloudcmd` executable, but it appears to need a few other things installed from the package, such as `libnextcloudsync.so`. What platform are you running your server on?"
    } ]
  },
  "kind" : "replies",
  "slug" : "2020/04/pc8wp",
