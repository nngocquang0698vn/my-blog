...
- Had my first experience with Netlify functions while [writing micropub-media-endpoint-proxy.netlify.com](/posts/2020/02/29/media-endpoint-proxy/). I'd originally planned to write it in Golang to learn a little Go, but had issues with the local development process for writing an AWS Lambda, and ended up sticking with Node, which I could iterate a little quicker on.
...
- Had a [lovely Sunday lunch](/mf2/2020/03/4csf2/) with <span class="h-card"><a class="u-url" href="https://annadodson.co.uk">Anna</a></span> at <span class="h-card"><a class="u-url" href="https://www.fothergillsnottingham.com/">Fothergills</a></span>
