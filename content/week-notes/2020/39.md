...
- Spent some time this week adding more [JSR380 tests]({{< ref 2020-08-06-trigger-jsr380-manually >}}), but found that I needed to run a full `@SpringBootTest` so I could set up all the `ConstraintValidator`s correctly.
